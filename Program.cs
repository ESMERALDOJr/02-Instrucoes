...
namespace Instrucoes
{
    class ProgramManager
    {
        ...
        static void InstrucaoForeach(string[] args)
        {
            ...
            // Todas essas instruções anteriores são de repetições.
        
        static void InstrucaoBrek(string[] args)
        {
            while (true)
            {
        ...
        static void InstrucaoTryCatchFinallyThrow(string[] args)
        {
            ...
            {
                Console.WriteLine($"Erro genérico: {e.Messege}");
            }
            finally
            {
        ...
        {
            using (System.IO.TextWriter w = Sysytem.IO.File.CreateText("teste.txt"))
            {
                w.WriteLine("Line 1");
                w.WriteLine("Line 2");
                w.WriteLine("Line 3");
